<template>
  <div id="reporte-pdf" class="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-orange-50 py-8">
    <!-- Header -->
    ...
    <h3 class="text-lg font-semibold text-red-700 flex items-center mb-2">
    ...
    <h3 class="text-lg font-semibold text-blue-700 flex items-center mb-2">
    ...
    <h3 class="text-lg font-semibold text-orange-700 flex items-center mb-2">
      <svg class="w-5 h-5 text-orange-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
      </svg>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div class="flex gap-2">
        <button @click="aplicarFiltros" class="bg-orange-600 hover:bg-orange-700 text-white px-3 py-1 rounded text-sm">Aplicar</button>
        <button @click="limpiarFiltros" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-1 rounded text-sm">Limpiar</button>
        <button @click="establecerFechasPorDefecto" class="bg-gray-100 hover:bg-gray-200 text-gray-600 px-3 py-1 rounded text-sm">Último mes</button>
      </div>
    </div>
        </div>
      </div>
      ...
      <div class="p-6">
        ...
        <div v-else class="text-center py-12">
          <div class="h-24 w-24 text-gray-400 mb-4">
