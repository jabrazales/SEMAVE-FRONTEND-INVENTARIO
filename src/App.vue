    ...
    <nav class="w-full bg-gradient-to-br from-gray-600 to-gray-700 px-4 md:px-8 py-4 sticky top-0 z-10 shadow-lg mb-6">
      <div class="flex justify-between items-center">
        <div class="flex items-center gap-3">
          <img :src="logo" alt="Logo" class="h-10 w-10 object-contain select-none" />
        ...
        <div class="hidden md:flex gap-4 items-center">
          ...
          <button
            ...
            class="ml-6 px-5 py-2 rounded-full font-semibold text-base bg-orange-500 text-white hover:bg-orange-600 transition-all duration-300 shadow-md border-2 border-orange-500"
            title="Cerrar sesión"
          >
            Cerrar sesión
          </button>
      ...
      <transition name="fade">
        <div v-if="menuAbierto" class="md:hidden flex flex-col gap-2 mt-4 bg-gray-700/95 rounded-xl shadow-lg p-4 animate-fade-in">
          ...
          <button
            @click="logueado = false; menuAbierto = false"
            class="w-full px-4 py-3 rounded-full font-semibold text-base bg-orange-500 text-white hover:bg-orange-600 transition-all duration-300 shadow-md border-2 border-orange-500 mt-2"
            title="Cerrar sesión"
          >
            Cerrar sesión
          </button>
